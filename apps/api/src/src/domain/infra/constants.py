# src/domain/infra/constants.py
"""Application-wide constants and configuration values.

Moved from src/constants.py to src/domain/infra/constants.py (ODY-19 / P2.2).
The original location keeps a backward-compat shim.
"""
import os

from .runtime_paths import get_app_root, get_default_data_dir
