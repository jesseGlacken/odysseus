"""Generated-image path resolution and serving helpers.

Moved from src/generated_images.py to src/domain/infra/generated_images.py (ODY-19 / P2.2).
...
from .constants import GENERATED_IMAGES_DIR
