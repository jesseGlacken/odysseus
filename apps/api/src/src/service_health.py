...
def email_health(accounts: List[Dict[str, Any]],
    ...
    if connect is None:
        from src.email_helpers_extracted import _imap_connect
...
def providers_health(endpoints: List[Dict[str, Any]],
    ...
    if probe is None:
        from src.model_extracted import _probe_endpoint as probe
...
def _gather_inputs() -> Dict[str, Any]:
    ...
    try:
        from src.email_helpers_extracted import _list_email_accounts
